...
- A Biel.ai Business or Enterprise plan.
- An API key with `chat_create` permission (from [Team Settings](https://app.biel.ai)).
- Documentation already indexed in your Biel.ai project.
...
1. Log in to your Biel.ai account at [app.biel.ai](https://app.biel.ai).
...
Import the OpenAPI schema to connect your GPT to the Biel.ai API:
...
1. Try one of your conversation starters.
