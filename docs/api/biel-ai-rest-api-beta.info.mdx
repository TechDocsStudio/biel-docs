...
Biel API uses a granular permission system with API key authentication. The access requirements depend on whether your project is public or private:
...
### Private projects  
- **All operations** require either user authentication OR a valid API key with appropriate permissions
...
- Each API key can have different permission sets for different use cases
