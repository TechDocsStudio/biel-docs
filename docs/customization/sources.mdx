...
In Biel.ai, you can configure various types of sources to index content for both your chatbot and search widget.
These sources allow the chatbot to provide accurate and relevant answers and enable the search widget to find and display relevant content to users.
...
If your build gets stuck during indexing, contact our support team through the [Contact page](https://biel.ai/contact). Include your project configuration and source details.

### First crawl issues

Initial crawls may require manual configuration to support your site's specific structure. Our team can help optimize the indexing process for your documentation.

For assistance with crawling issues, visit the [Contact page](https://biel.ai/contact).
