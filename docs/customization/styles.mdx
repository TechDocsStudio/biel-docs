...
:root {
    ...
    --biel-bot-content-box-shadow: 0px 1px 2px 0px rgba(60, 64, 67, .30), 0px 2px 6px 2px rgba(60, 64, 67, .15);
    ...
    --biel-suggested-questions-title-font-size: var(--biel-text-font-size);
    ...
    --biel-search-content-box-shadow: 0px 1px 2px 0px rgba(60, 64, 67, .30), 0px 2px 6px 2px rgba(60, 64, 67, .15);
