...
| **Layout**             |  |  |
| `project`              | **Required**<br />**Type**: `string`<br /><br />The project ID.                                |
| `api-key`              | **Type**: `string`<br />**Default value**: ``<br /><br />If project is marked as private, API key with "create_chat, project_read, and project_search" permissions is required. If public, not needed.|
