...
| `inputPlaceholderText` | **Type**: `string`<br />**Default value**: `Type your message`<br /><br />Placeholder text displayed in the chatbot's input field. |
| `sendButtonText`       | **Type**: `string`<br />**Default value**: `Send`<br /><br />Text displayed on the send button next to the input field. |
