...
The Biel.ai widget is highly customizable, allowing you to customize its behavior to suit your application's needs.
...
Biel bot enables a conversational chat powered by AI.
...
| `modal-position`       | **Type**: `string`<br />**Default value**: `center`<br />**Available values:** `center`, `bottom-right`, `bottom-left`<br /><br />Position of the modal.|

## Biel search

Biel search offers a search-based ineraction that allows users to query documentation or other indexed content.
