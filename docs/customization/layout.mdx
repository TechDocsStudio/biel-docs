...
| `modal-position`       | **Type**: `string`<br />**Default value**: `center`<br />**Available values:** `center`, `top-center`, `top-left`, `top-right`, `center-left`, `center-right`, `bottom-left`, `bottom-right`, `sidebar-left`, `sidebar-right`<br /><br />Determines where the chat modal appears on the screen when opened. Use `sidebar-left` or `sidebar-right` to dock the chat as a side panel.|
...
| `footer-text`          | **Type**: `string`<br />**Default value**: `AI answers may be inaccurate. Verify with official sources.`<br /><br />Footer text. |
...
| `modal-position`       | **Type**: `string`<br />**Default value**: `top-center`<br />**Available values:** `center`, `top-center`, `top-left`, `top-right`, `center-left`, `center-right`, `bottom-left`, `bottom-right`, `sidebar-left`, `sidebar-right`<br /><br />Position of the search modal. Use `sidebar-left` or `sidebar-right` to dock as a side panel.|
