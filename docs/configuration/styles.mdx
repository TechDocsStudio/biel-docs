...
:root {
    ...
    --biel-button-dark-bg-color: var(--feedback-primary-color);
    --biel-button-dark-text-color: var(--feedback-white-color);
    --biel-button-light-bg-color: var(--feedback-white-color);
    --biel-button-light-text-color: var(--feedback-primary-color);
    --biel-button-text-font-size: var(--feedback-text-font-size);
